        ...
        return (
          <div key={alien.id}>
            ...
            >
              ...
              <img src={alien.images[1]} className='absolute inset-0 h-full w-full object-cover mix-blend-luminosity opacity-50' />
              <img src={alien.images[0]} className='absolute h-5/6 left-0 m-2 z-10' />
