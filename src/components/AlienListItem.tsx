...
import omnitrix from '/omnitrix.svg';
      ...
      {filteredAlienList.map((alien) => {
        return (
          <div key={alien.id}>
            ...
            >
              <img src={omnitrix} alt={alien.name} className='absolute inset-0 h-full w-20 ml-1 mt-0.5 object-contatin mix-blend-lighten opacity-40' />
              <img src={alien.images[1]} alt={alien.name} className='absolute inset-0 h-full w-full object-cover mix-blend-luminosity opacity-50' />
              <img src={alien.images[0]} alt={alien.name} className='absolute h-5/6 left-0 m-2 z-10' />
